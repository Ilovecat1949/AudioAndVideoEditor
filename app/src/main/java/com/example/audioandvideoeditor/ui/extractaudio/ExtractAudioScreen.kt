package com.example.audioandvideoeditor.ui.extractaudio
...
fun ExtractAudioScreen(
    ...
    ExtractAudioScreen2(file, nextDestination, viewModel)
}
        ...
        AlertDialog(
            ...
            confirmButton = {
                Button(onClick = {
                    ...
                    startExtractAudio(context , file, nextDestination, viewModel)
                ...
                Column(modifier=Modifier.selectableGroup()) {
                    viewModel.targetFormatOptions.forEach {
                        ...
                        Row(
                            ...
                            Text(
                                text = if(text.isEmpty()) stringResource(R.string.label_default) else text,
