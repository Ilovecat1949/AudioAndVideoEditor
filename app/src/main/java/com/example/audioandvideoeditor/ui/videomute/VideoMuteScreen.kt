package com.example.audioandvideoeditor.ui.videomute
...
fun VideoMuteScreen(
    ...
    VideoMuteScreen2(file, nextDestination, viewModel)
}
        ...
        AlertDialog(
            ...
            confirmButton = {
                Button(onClick = {
                    ...
                    startVideoMute(context , file, nextDestination, viewModel)
