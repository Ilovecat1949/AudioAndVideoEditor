package com.example.audioandvideoeditor.ui.ffmpeginfo
...
import com.example.audioandvideoeditor.ui.ffmpeginfo.FFmpegInfoViewModel
...
private fun FFmpegInfoList(
    ...
    LazyColumn(
        ...
        item {
            Text(text= AppApplication.INSTANCE.taskRepository .getFFmpegInfo(ffmpegInfoViewModel.show_flag.value))
        }
    }
}
